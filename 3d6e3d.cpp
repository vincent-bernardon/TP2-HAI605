...
// 3 dilatations
applyMorphologicalOperation(ImgIn, ImgOut, nH, nW, 0);
applyMorphologicalOperation(ImgOut, ImgIn, nH, nW, 0);
applyMorphologicalOperation(ImgIn, ImgOut, nH, nW, 0);

// 6 érosions
applyMorphologicalOperation(ImgOut, ImgIn, nH, nW, 1);
applyMorphologicalOperation(ImgIn, ImgOut, nH, nW, 1);
applyMorphologicalOperation(ImgOut, ImgIn, nH, nW, 1);
applyMorphologicalOperation(ImgIn, ImgOut, nH, nW, 1);
applyMorphologicalOperation(ImgOut, ImgIn, nH, nW, 1);
applyMorphologicalOperation(ImgIn, ImgOut, nH, nW, 1);
...
// Maintenant, ImgIn contient le résultat final
